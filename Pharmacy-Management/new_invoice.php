    ...
    <div id="add_new_customer_model">
      <div class="modal-dialog">
      	<div class="modal-content">
            ...
            <div class="font-weight-bold">Hóa đơn mới</div>
    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('clipboard', 'Hóa đơn', 'Tạo hóa đơn mới');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          ...
          <div class="row col col-md-12">
            <div class="col col-md-3 form-group">
              ...
              <input id="customers_name" type="text" class="form-control" placeholder="Customer Name" name="customers_name" onkeyup="showSuggestions(this.value, 'namcustomers_name');">
            ...
            <div class="col col-md-3 form-group">
              ...
              <input id="customers_address" type="text" class="form-control" name="customers_address" placeholder="Địa chỉ" disabled>
            </div>
            <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="invoice_number">Số hóa đơn :</label>
              <input id="invoice_number" type="text" class="form-control" name="invoice_number" placeholder="Invoice Number" disabled>
            </div>
            <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="">Hình thức thanh toán :</label>
            ...
            <div class="col col-md-2 form-group">
               <label class="font-weight-bold" for="">Ngày :</label>
          ...
          <div class="row col col-md-12">
            <div class="col col-md-2 form-group">
              <button class="btn btn-primary form-control" onclick="document.getElementById('add_new_customer_model').style.display = 'block';">Thêm khách hàng mới</button>
            </div>
            <div class="col col-md-1 form-group"></div>
            <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="customers_contact_number">Số điện thoại :</label>
              <input id="customers_contact_number" type="number" class="form-control" name="customers_contact_number" placeholder="Phone" disabled>
            </div>
          </div>
          ...
          <div class="row col col-md-12">
            <div class="row col col-md-12 font-weight-bold">
              ...
              <div class="col col-md-1">Định lượng</div>
              <div class="col col-md-1">MRP</div>
              <div class="col col-md-1">Chiết khấu(%)</div>
              <div class="col col-md-1">Số tiền</div>
              <div class="col col-md-2">Hoạt động</div>
            </div>
          </div>
          <div class="col col-md-12">
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-2 form-group float-right">
              <label class="font-weight-bold" for="">Tổng cộng:</label>
              <input type="text" class="form-control" value="0" id="total_amount" disabled>
            </div>
            <div class="col col-md-2 form-group float-right">
              <label class="font-weight-bold" for="">Tổng khấu trừ :</label>
              <input type="text" class="form-control" value="0" id="total_discount" disabled>
            </div>
            <div class="col col-md-2 form-group float-right">
              <label class="font-weight-bold" for="">Còn lại :</label>
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-2 form-group float-right">
              <label class="font-weight-bold" for="">Số tiền thanh toán :</label>
              <input type="text" class="form-control" name="total_discount" onkeyup="getChange(this.value);">
            </div>
            <div class="col col-md-2 form-group float-right">
              <label class="font-weight-bold" for="">Thối lại :</label>
