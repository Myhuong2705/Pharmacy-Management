    ...
    <div id="add_new_supplier_model">
      <div class="modal-dialog">
      	<div class="modal-content">
            ...
            <div class="font-weight-bold">Thêm nhà cung cấp</div>
    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('bar-chart', 'Thêm mua hàng', 'Thêm mua hàng mới');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="paytype">Thanh toán :</label>
              <select id="payment_type" name="paytype" class="form-control">
              	<option value="Cash Payment">Tiền mặt</option>
                <option value="Net Banking">Chuyển khoản</option>
                <option value="Payment Due">Thẻ</option>
              </select>
            </div>

            <div class="col col-md-2 form-group">
               <label class="font-weight-bold" for="invoice_date">Ngày :</label>
          ...
          <div class="row col col-md-12 font-weight-bold">
            ...
            <div class="col col-md-2">Lô hàng</div>
            <div class="col col-md-1">Hạn dùng (mm/yy)</div>
            <div class="col col-md-1">Giá tiền</div>
            <div class="col col-md-1">M.R.P</div>
            <div class="col col-md-1">Số lượng</div>
            <div class="row col col-md-3">
              <div class="col col-md-7">Tổng tiền</div>
              <div class="col col-md-5">Hoạt động</div>
            </div>
          </div>
          <div class="col col-md-12">
            <hr class="col-md-12" style="padding: 0px; border-top: 2px solid  #02b6ff;">
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-2 form-group float-right">
              <label class="font-weight-bold" for="">Tổng thanh toán :</label>
