    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('book', 'Báo cáo mua', 'Báo cáo mua mới');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          ...
          <div class="col-md-12 form-group form-inline">
            <label class="font-weight-bold" for="">Từ ngày:&emsp;</label>
            <input type="date" class="form-control" id="start_date" onchange="showReport('purchase');">
            &emsp;
            <label class="font-weight-bold" for="">Đến ngày :&emsp;</label>
