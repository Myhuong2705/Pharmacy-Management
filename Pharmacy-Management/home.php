      ...
      <div class="container">
        ...
        <div class="row">
          <div class="row col col-xs-8 col-sm-8 col-md-8 col-lg-8">
            ...
            <?php
              ...
              createSection1('manage_customer.php', 'Tổng số khách hàng', 'customers');
              createSection1('manage_supplier.php', 'Tổng nhà cung cấp', 'suppliers');
              createSection1('manage_medicine.php', 'Tổng số thuốc', 'medicines');
              ...
              createSection1('manage_invoice.php', 'Tổng hóa đơn', 'invoices');
            ?>
              ...
              <table class="table table-bordered table-striped table-hover">
                <tbody>
                  ...
                  <tr>
                    ...
                    ?>
                    <th>Doanh số</th>
                    <th class="text-success"><?php echo $total; ?> VNĐ</th>
                  </tr>
                  <tr>
                    <?php
                      //echo $date;
                    ...
                    ?>
                    <th>Mua về</th>
                    <th class="text-danger"> <?php echo $total; ?> VNĐ</th>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <div class="row">
          ...
          <?php
            ...
            createSection2('address-card', 'new_invoice.php', 'Tạo hóa đơn mới');
            createSection2('handshake', 'add_customer.php', 'Thêm khách hàng mới');
            createSection2('shopping-bag', 'add_medicine.php', 'Thêm thuốc mới');
            createSection2('group', 'add_supplier.php', 'Thêm nhà cung cấp mới');
            createSection2('bar-chart', 'add_purchase.php', 'Thêm giao dịch mua mới');
            createSection2('book', 'sales_report.php', 'Báo cáo bán hàng');
            createSection2('book', 'purchase_report.php', 'Báo cáo mua hàng');
          ?>
