    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('bar-chart', 'Quản lý mua hàng', 'Quản lý mua hàng hiện có');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          <div class="col-md-12 form-group form-inline">
            ...
            <input type="number" class="form-control" id="by_voucher_number" placeholder="Theo số đơn mua" onkeyup="searchPurchase(this.value, 'VOUCHER_NUMBER');">
            &emsp;<input type="text" class="form-control" id="by_suppliers_name" placeholder="Theo tên" onkeyup="searchPurchase(this.value, 'SUPPLIER_NAME');">
            &emsp;<input type="number" class="form-control" id="by_invoice_number" placeholder="Số điện thoại" onkeyup="searchPurchase(this.value, 'INVOICE_NUMBER');">
          ...
          <div class="col col-md-12 table-responsive">
            <div class="table-responsive">
            	<table class="table table-bordered table-striped table-hover">
                    ...
                    <th style="width: 12%;">Tình trạng thanh toán</th>
