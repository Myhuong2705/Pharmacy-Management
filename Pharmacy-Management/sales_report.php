    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('book', 'Báo cáo bán hàng', 'Báo cáo bán hàng hiện có');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          ...
          <div class="col-md-12 form-group form-inline">
            <label class="font-weight-bold" for="">Ngày bán :&emsp;</label>
            <input type="date" class="form-control" id="start_date" onchange="showReport('sales');">
            &emsp;
            <label class="font-weight-bold" for="">Ngày hết :&emsp;</label>
          ...
          <div class="col-md-12 text-center">
            <button class="btn btn-primary" onclick="printReport('Sales');">In</button>
          </div>
